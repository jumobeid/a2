            ...
            <?php
             switch ($today) {
              ...
              <p>Monday</p>
                  ...
                  <input type="radio" name="monday" value=10 <?php if($mCost=="10") echo 'CHECKED'?>> Tomato Mozarella<small> 10&#36;</small><br>

                  <input type="radio" name="monday" value=5 <?php if($mCost=="5") echo 'CHECKED'?>> Chicken Salad<small> 7&#36;</small><br>
                <?php  break;

              case "Tuesday":?>
              <br><p>Tuesday</p>

                  <input type="radio" name="tuesday" value=5 <?php if($tCost=="5") echo 'CHECKED'?>> Greek Salad Wrap<small> 5&#36;</small><br>

                  <input type="radio" name="tuesday" value=11<?php if($tCost=="11") echo 'CHECKED'?>> Dado Wrap<small> 11&#36;</small><br>
              <?php  break;
              ...
              <br><p>Wednesday</p>
                  ...
                  <input type="radio" name="wednesday" value=5 <?php if($wCost=="5") echo 'CHECKED'?>> Red Papper Hummus<small> 5&#36;</small><br>

                  <input type="radio" name="wednesday" value=9 <?php if($wCost=="9") echo 'CHECKED'?>> Roasted Turkey<small> 9&#36;</small><br>
              <?php    break;
              case "Thursday":?>
              <br><p>Thursday</p>

              <input type="radio" name="thursday" value=6 <?php if($thCost=="6") echo 'CHECKED'?>> Carrot Ginger Hummus<small> 6&#36;</small><br>

              <input type="radio" name="thursday" value=9 <?php if($thCost=="9") echo 'CHECKED'?>> Roasted Turkey<small> 9&#36;</small><br>

             <?php  break;
              case "Friday":?>
              <br><p>Friday</p>

              <input type="radio" name="friday" value=11 <?php if($fCost=="11") echo 'CHECKED'?>> Dado Wrap<small> 11&#36;</small><br>

              <input type="radio" name="friday" value=5  <?php if($fCost=="5") echo 'CHECKED'?>> Tuna Salad<small> 5&#36;</small><br>
